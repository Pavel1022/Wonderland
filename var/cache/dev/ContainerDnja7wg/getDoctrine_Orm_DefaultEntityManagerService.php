...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/WonderlandBundle/Entity')]), 'WonderlandBundle\\Entity');

$a->setEntityNamespaces(['WonderlandBundle' => 'WonderlandBundle\\Entity']);
